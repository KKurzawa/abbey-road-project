...
const Footer = () => {
    ...
    return (
        <footer className='footer flex flex-col justify-center items-center'>
            <ul className='footer-icons flex flex-row text-6xl gap-10 mt-5 mb-2'>
            ...
            <article className='footer-text-container flex flex-col justify-center items-center w-full mb-5 text-xs md:text-xl'>
                <a href='mailto:kurzawa1@yahoo.com' className='mailto flex justify-center py-[.1rem]'>Email Us</a>
                <a href='tel:12485682806' className='phone flex justify-center py-[.1rem]'>Call Us</a>
                <p className='copyright flex justify-center py-[.1rem]'>Copyright &copy; {today.getFullYear()} The Abbey Road Project - All Rights Reserved</p>
