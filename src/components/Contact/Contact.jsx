...
const Contact = () => {
    ...
    return (
        <main id='Contact' className='contact-main'>
            ...
            <article className='contact-form-container flex flex-col items-center'>
                ...
                <button onClick={() => setTimeout(() => {
                    const contactTopBtn = document.querySelector('#top');
                    contactTopBtn?.scrollIntoView({ behavior: 'smooth' })
                }, 500)} className='contact-top-btn flex justify-center w-fit h-fit gap-[.15rem]'>
